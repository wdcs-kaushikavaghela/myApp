...
async function getOneUser(id){
  try {
    ...
    if(user){
      return mapper.responseMappingWithData(adminConst.CODE.Success, adminConst.MESSAGE.Success ,user)
    }else{
      return mapper.responseMapping(
        adminConst.CODE.DataNotFound,
        adminConst.MESSAGE.TemplateNotFound
...
async function getOneTemplate(id){
  try {
    ...
    // console.log("template" , template);
    if(template){
      return mapper.responseMappingWithData(adminConst.CODE.Success, adminConst.MESSAGE.Success , template)
    }else{
      return mapper.responseMapping(
        adminConst.CODE.DataNotFound,
        adminConst.MESSAGE.TemplateNotFound
